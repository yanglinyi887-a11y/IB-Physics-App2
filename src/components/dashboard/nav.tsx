...
const links = [
  ...
  { href: "/editor", label: "IA Editor", icon: Edit3 },
  { href: "/topics", label: "Topic Generator", icon: Lightbulb },
  { href: "/coach", label: "AI Coach", icon: MessageCircle },
  { href: "/review", label: "Draft Review", icon: FileSearch },
  { href: "/analysis", label: "Data Analysis", icon: BarChart3 },
  { href: "/exemplars", label: "Exemplar Library", icon: BookOpen },
  { href: "/progress", label: "Progress", icon: TrendingUp },
  { href: "/premium", label: "Premium", icon: Crown },
  { href: "/relay", label: "Relay Station", icon: Key },
]
