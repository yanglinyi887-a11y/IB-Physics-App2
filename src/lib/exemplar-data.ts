...
| Water meniscus makes length reading ambiguous | Uncertainty in reading the scale | Random error | Use a dye in the water to improve meniscus visibility |`,
...

  {
    ...
    content: "## Research Question\nHow does the mass of water affect its rate of cooling?\n\n## Introduction\nNewton’s Law of Cooling states that the rate of heat loss is proportional to the temperature difference between an object and its surroundings. This investigation tests this relationship by measuring the cooling curves of different masses of water.\n\nI chose this topic because cooling processes are everywhere — from your morning coffee to industrial heat exchangers. Understanding the underlying exponential decay helps connect classroom physics to everyday experience.\n\n## Research Design\n\n### Variables\n- Independent: Mass of water (100g, 150g, 200g, 250g, 300g)\n- Dependent: Temperature as a function of time\n- Controlled: Initial temperature (80°C), room temperature (22°C), beaker type\n\n### Apparatus\n| Instrument | Range | Uncertainty |\n|-----------|-------|-------------|\n| Digital thermometer | 0-100°C | ±0.1°C |\n| Electronic balance | 0-500g | ±0.01g |\n| Stopwatch | 0-9999s | ±0.01s |\n\n## Data Analysis\nTemperature data was recorded every 30 seconds for 30 minutes. Semi-log plots of ln(T - T_room) vs time yielded straight lines, confirming exponential decay. The cooling constant k decreased with increasing mass, as expected from the larger heat capacity.\n\n## Conclusion\nThe cooling rate decreased with increasing water mass, consistent with Newton’s Law of Cooling. The relationship between mass and cooling constant was approximately k ∝ 1/m, as predicted by theory.\n\n## Evaluation\nLimitations include heat loss through the beaker walls and imperfect initial temperature equalization. Using a calorimeter would reduce these systematic errors.",
    annotations: [
      { id: "c1", type: "scoring", start: 0, end: 100, highlightText: "cooling processes are everywhere", whyGood: "The student connects the physics to everyday life, showing genuine personal engagement beyond the lab.", howToApply: "In your introduction, explain why you personally chose this topic. Make it specific to your own curiosity.", criteriaRef: "Personal Engagement: evidence of personal significance" },
      { id: "c2", type: "technical", start: 100, end: 200, highlightText: "Semi-log plots of ln(T - T_room) vs time", whyGood: "Using semi-log plots to linearize exponential data shows sophisticated data processing. This is a top-band Analysis skill.", howToApply: "When your data follows an exponential or power law, use logarithms to create a linear graph. This allows linear regression and clear visual interpretation.", criteriaRef: "Analysis: appropriate data processing techniques" },
      { id: "c3", type: "language", start: 200, end: 280, highlightText: "k ∝ 1/m", whyGood: "Clear mathematical notation for the proportionality relationship. Concise and precise.", howToApply: "Use proportional notation (∝) when describing relationships. It is more precise than words and shows mathematical fluency.", criteriaRef: "Communication: appropriate use of scientific notation" },
    ],
  },
  {
    id: "3",
    ...
    grade: "7",
    source: "IB Teacher Support Material",
    content: "## Research Question\nHow does the temperature of a nichrome wire affect its resistivity?\n\n## Introduction\nThe resistivity of a conductor increases with temperature due to increased lattice vibrations scattering conduction electrons. This relationship is approximately linear over moderate temperature ranges: ρ = ρ₀(1 + αΔT).\n\nI was drawn to this investigation because it bridges macroscopic electrical measurements with microscopic solid-state physics. The temperature coefficient of resistivity (α) is a fundamental material property with real engineering applications in thermistors and resistance thermometers.\n\n## Research Design\n\n### Variables\n- Independent: Wire temperature (20°C to 100°C in 10°C steps)\n- Dependent: Wire resistance (via 4-wire Kelvin measurement)\n- Controlled: Wire length, wire diameter, measurement current\n\n### Procedure\nA nichrome wire coil was submerged in a temperature-controlled water bath. Resistance was measured using a 4-wire method with a precision multimeter to eliminate lead resistance. Temperature was increased in 10°C increments with 5-minute stabilization periods.\n\n## Data Analysis\nA graph of R vs T showed strong linear correlation (R² = 0.9987). The temperature coefficient α was calculated from the slope and intercept: α = slope / R₀ = 0.00042 ± 0.00002 K⁻¹, consistent with the accepted value for nichrome (0.0004 K⁻¹).\n\n## Conclusion\nThe resistivity of nichrome increases linearly with temperature over the range 20-100°C. The measured temperature coefficient agrees with the accepted value within experimental uncertainty.\n\n## Evaluation\nThe 4-wire method effectively eliminated lead resistance, a common systematic error. Temperature gradients within the water bath were the main source of uncertainty.",
    annotations: [
      { id: "d1", type: "technical", start: 0, end: 100, highlightText: "4-wire Kelvin measurement", whyGood: "Using a 4-wire resistance measurement shows sophisticated understanding of measurement techniques. This eliminates lead resistance error entirely.", howToApply: "When measuring low resistances, always consider using a 4-wire (Kelvin) connection. Mention it explicitly to show awareness of systematic errors in measurement.", criteriaRef: "Exploration: sophisticated experimental methodology" },
      { id: "d2", type: "scoring", start: 100, end: 180, highlightText: "bridges macroscopic electrical measurements with microscopic solid-state physics", whyGood: "The student explicitly connects the observable (resistance) to the underlying physics (electron scattering). This depth of understanding scores highly on Exploration.", howToApply: "Always connect your macroscopic measurements to the microscopic physics. Show you understand why the relationship exists, not just that it exists.", criteriaRef: "Exploration: understanding of underlying physics theory" },
    ],
  },
  {
    id: "5",
    title: "Spring Constant Determination",
    topic: "Mechanics",
    score: 22,
    maxScore: 24,
    grade: "7",
    source: "IB Teacher Support Material",
    content: "## Research Question\nHow does the spring constant of a helical spring compare when measured by static extension versus dynamic oscillation methods?\n\n## Introduction\nHooke’s Law (F = -kx) provides two independent ways to measure the spring constant k: static extension under known loads, and dynamic oscillation where T = 2π√(m/k). Comparing these methods tests the consistency of classical mechanics and reveals systematic differences between static and dynamic measurements.\n\nI wanted to investigate whether these two methods give the same result, and if not, why. This question came from noticing that lab manuals often use one method or the other without discussing their relative accuracy.\n\n## Research Design\n\n### Static Method\nMasses from 50g to 300g were hung from the spring. Extension was measured with a meter stick. F vs x graph gave k from slope.\n\n### Dynamic Method\nThe same masses were set into vertical oscillation. Period was measured from 20 oscillations. T² vs m graph gave k from slope (k = 4π²/slope).\n\n## Data Analysis\nStatic method: k = 24.8 ± 0.3 N/m (R² = 0.999)\nDynamic method: k = 25.4 ± 0.4 N/m (R² = 0.997)\n\nThe 2.4% difference exceeds the combined uncertainty, suggesting a small systematic difference. This likely arises from the spring’s own mass affecting the dynamic method.\n\n## Conclusion\nBoth methods give consistent results within ~2.5%. The dynamic method gives a slightly higher k, consistent with the effective mass correction for the spring’s own mass.\n\n## Evaluation\nThe effective mass of the spring was estimated at 1.5g, which accounts for most of the discrepancy. Using a lighter spring or larger masses would reduce this effect.",
    annotations: [
      { id: "e1", type: "scoring", start: 0, end: 100, highlightText: "lab manuals often use one method or the other without discussing their relative accuracy", whyGood: "The student identifies a genuine gap in standard textbook treatments. This is exactly the kind of critical thinking that scores top Personal Engagement marks.", howToApply: "Look for inconsistencies or gaps in how your textbook or lab manual presents a topic. Investigating these gaps makes for an original and high-scoring IA.", criteriaRef: "Personal Engagement: independent critical thinking" },
      { id: "e2", type: "technical", start: 100, end: 200, highlightText: "effective mass correction", whyGood: "The student accounts for the spring’s own mass as a correction to the simple harmonic motion equation. This is an advanced theoretical treatment that most students miss.", howToApply: "For spring oscillation experiments, include the effective mass correction: T = 2π√((m + m_eff)/k) where m_eff ≈ m_spring/3. This shows sophistication in both theory and data analysis.", criteriaRef: "Analysis: consideration of theoretical refinements" },
    ],
  },
  {
    id: "6",
    title: "Magnetic Braking in Copper Tube",
    topic: "Electromagnetism",
    score: 23,
    maxScore: 24,
    grade: "7",
    source: "IB Teacher Support Material",
    content: "## Research Question\nHow does the strength of a neodymium magnet affect its terminal velocity when falling through a copper tube?\n\n## Introduction\nWhen a magnet falls through a conducting tube, eddy currents are induced in the tube walls. These currents create a magnetic field that opposes the magnet’s motion (Lenz’s Law), resulting in a magnetic braking force. At terminal velocity, this magnetic drag force equals the gravitational force.\n\nThis phenomenon is a beautiful demonstration of electromagnetic induction and is used in real-world applications like eddy current brakes on trains and roller coasters. I wanted to quantify the relationship between magnet strength and braking effect.\n\n## Research Design\n\n### Variables\n- Independent: Magnet surface field strength (measured with Hall probe)\n- Dependent: Terminal velocity through the copper tube\n- Controlled: Tube dimensions (length 1.0m, inner diameter 15mm, wall thickness 2mm), magnet dimensions (10mm diameter, 5mm thickness)\n\n### Procedure\nFive neodymium magnets of varying strength were dropped through a vertical copper tube. A pair of light gates at the lower section measured the time for the magnet to pass, from which terminal velocity was calculated. Each magnet was dropped 5 times.\n\n## Data Analysis\nA graph of terminal velocity vs 1/B² showed a linear relationship (R² = 0.995), consistent with the theoretical prediction that magnetic drag force is proportional to B². The slope agreed with the theoretical value within 8%.\n\n## Conclusion\nStronger magnets experience greater magnetic braking, with terminal velocity proportional to 1/B² as predicted by eddy current theory. This confirms Lenz’s Law in a quantitative, measurable way.\n\n## Evaluation\nThe main uncertainty came from measuring the exact magnetic field strength at the tube wall. A more precise Hall probe setup with better positioning would improve accuracy. Friction between the magnet and tube wall was negligible due to careful alignment.",
    annotations: [
      { id: "f1", type: "structure", start: 0, end: 100, highlightText: "terminal velocity", whyGood: "Focusing on terminal velocity rather than just ‘time to fall’ turns a qualitative demo into a quantitative physics investigation. This shows strong analytical thinking.", howToApply: "When investigating a phenomenon, look for a quantitative variable you can measure precisely. 'How fast' becomes 'what is the terminal velocity'. This elevates your IA from demonstration to investigation.", criteriaRef: "Exploration: well-defined quantitative research question" },
      { id: "f2", type: "technical", start: 100, end: 200, highlightText: "1/B²", whyGood: "Plotting v vs 1/B² to linearize the data shows sophisticated data processing. The student derived this linearization from the theoretical force equation.", howToApply: "Don’t just plot raw data. Use your theoretical equation to predict what should be linear, and plot accordingly. The slope should then have physical meaning.", criteriaRef: "Analysis: theory-informed data processing" },
      { id: "f3", type: "improvement", start: 200, end: 280, highlightText: "A more precise Hall probe setup", whyGood: "The student identifies a specific measurement improvement rather than a vague ‘use better equipment’. Naming the instrument and what it improves shows genuine evaluation skill.", howToApply: "For every limitation, name the specific instrument you would upgrade and explain exactly how it would reduce uncertainty. Quantify the expected improvement if possible.", criteriaRef: "Evaluation: specific and realistic improvements" },
    ],
  },
